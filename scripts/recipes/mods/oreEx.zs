/*
    This script handles the recipes for Ore Excavation
...
static shapedRecipes as IIngredient[][][][IItemStack] = {
    <oeintegration:excavatemodifier> * 8 : [
			[
	  			[<ore:blockGold>, <silentgear:blueprint_pickaxe>, <ore:blockGold>],
	   			[<silentgear:blueprint_excavator>, <thebetweenlands:crimson_middle_gem_block>, <silentgear:blueprint_hammer>],
                [<ore:blockGold>, <silentgear:blueprint_axe>, <ore:blockGold>]
			]
	]
};
